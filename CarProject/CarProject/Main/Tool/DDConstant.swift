...
func DDGlobalNavBarColor() -> UIColor {
    return UIColor.init(r: 40, g: 208, b: 131)
}

// 价钱字体颜色
func DDPriceColor() -> UIColor {
    return UIColor.init(r: 255, g: 74, b: 143)
}
...
func timestampToDate(format: String, timestamp: String) -> String{
    ...
    let date = Date.init(timeIntervalSince1970: time ?? 0.0)
...
//    let timerZone = NSTimeZone.init(name: "Asia/Beijing")
//    let formatter = DateFormatter()
//    formatter.dateStyle = .medium
//    formatter.timeStyle = .short
//    formatter.dateFormat = "YYYY-MM-dd HH:mm:ss"
//    formatter.timeZone = timerZone! as TimeZone
...
/// 签名相关
// 常量App_key
let kApp_key = "4JCZdmhMYmPC/higK644q+1r/DE="
// 密钥
let kSecret = "2d072ca571bcee0d3baf1a16ab16c83fe154518ddaeaeee52844894aece5ebb7"
...
/// 首页头部的功能
let kHomefunction: Double = 180.0

/// 首页间距
let kHomeSpace: Double = 0.0
