...
class DDTabBarViewController: UITabBarController {
    ...
    public var homeVC = ZeroVC_0()
    public var hardwareVC = FistVC_0()
    public var careVC = SecondVC_0()
    public var mallVC = ThirdVC_0()
    ...
    private func setupUI() {
        ...
        tabBar.tintColor = DDGlobalNavBarColor()
    ...
    private func addChildViewControllers() {
        ...
        addChildViewController(childController: hardwareVC, title: "智能硬件", imageName: "hardware")
        addChildViewController(childController: careVC, title: "我的关爱", imageName: "care")
        addChildViewController(childController: mallVC, title: "商城", imageName: "mall")
